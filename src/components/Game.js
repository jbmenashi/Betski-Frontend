        ...
        <thead className="thead-dark">
          ...
          <tbody>
            <tr>
              ...
              <td><button type="button" className="btn btn-outline-dark" data-toggle="modal" data-target="#betInfoModal" onClick={() => this.props.selectBet(this.props.id, this.props.odds[2].away_over, this.props.away_team, this.props.home_team, this.props.spread, this.props.over_under, [this.props.odds[2].line, "A"], [this.props.away_team, this.props.odds[2].line, 0, this.props.odds[2].away_over, this.props.away_team, this.props.home_team])}>{this.props.odds[2].away_over}</button></td>
            </tr>
            <tr>
              ...
              <td><button type="button" className="btn btn-outline-dark" data-toggle="modal" data-target="#betInfoModal" onClick={() => this.props.selectBet(this.props.id, this.props.odds[1].home_under, this.props.away_team, this.props.home_team, this.props.spread, this.props.over_under, [this.props.odds[1].line, "H"], ["the Under", this.props.odds[1].line, this.props.over_under, this.props.odds[1].home_under, this.props.away_team, this.props.home_team])}>{this.props.odds[1].home_under}</button></td>

              <td><button type="button" className="btn btn-outline-dark" data-toggle="modal" data-target="#betInfoModal" onClick={() => this.props.selectBet(this.props.id, this.props.odds[2].home_under, this.props.away_team, this.props.home_team, this.props.spread, this.props.over_under, [this.props.odds[2].line, "H"], [this.props.home_team, this.props.odds[2].line, 0, this.props.odds[2].home_under, this.props.away_team, this.props.home_team])}>{this.props.odds[2].home_under}</button></td>
            </tr>
          </tbody>
        </table>
      </div>
