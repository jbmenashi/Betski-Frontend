        ...
        <caption>{moment(this.props.date).format('llll')}, spread: {this.props.spread}, total: {this.props.over_under}</caption>
          <tbody>
            ...
            <tr>
              ...
              <td onClick={() => this.props.selectBet(this.props.id, this.props.odds[2].away_over, this.props.away_team, this.props.home_team, this.props.spread, this.props.over_under, [this.props.odds[2].line, "A"], [this.props.away_team, this.props.odds[2].line, 0, this.props.odds[2].away_over, this.props.away_team, this.props.home_team])}>{this.props.odds[2].away_over}</td>
            </tr>
            <tr>
              ...
              <td onClick={() => this.props.selectBet(this.props.id, this.props.odds[1].home_under, this.props.away_team, this.props.home_team, this.props.spread, this.props.over_under, [this.props.odds[1].line, "H"], ["the Under", this.props.odds[1].line, this.props.over_under, this.props.odds[1].home_under, this.props.away_team, this.props.home_team])}>{this.props.odds[1].home_under}</td>
              <td onClick={() => this.props.selectBet(this.props.id, this.props.odds[2].home_under, this.props.away_team, this.props.home_team, this.props.spread, this.props.over_under, [this.props.odds[2].line, "H"], [this.props.home_team, this.props.odds[2].line, 0, this.props.odds[2].home_under, this.props.away_team, this.props.home_team])}>{this.props.odds[2].home_under}</td>
            </tr>
          </tbody>
        </table>
      </div>
